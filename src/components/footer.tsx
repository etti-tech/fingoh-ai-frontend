export default function Footer() {
  return (
    <footer className="mt-16 border-t border-zinc-200 bg-white py-8 dark:border-zinc-800 dark:bg-zinc-950">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-3 px-4 text-sm text-zinc-500 sm:px-6 lg:px-8 md:flex-row md:items-center md:justify-between dark:text-zinc-400">
